...
RAYGUIAPI bool GuiButtonCustom(Rectangle bounds, const char *text, Color borderColor, Color color, Color textTint);
...
bool GuiButtonCustom(Rectangle bounds, const char *text, Color borderColor, Color color, Color textTint)
{
    GuiControlState state = guiState;
    bool pressed = false;
    ...
    // Draw control
    //--------------------------------------------------------------------
    GuiDrawRectangle(bounds, GuiGetStyle(BUTTON, BORDER_WIDTH), Fade(borderColor, guiAlpha), Fade(color, guiAlpha));
    GuiDrawText(text, GetTextBounds(BUTTON, bounds), GuiGetStyle(BUTTON, TEXT_ALIGNMENT), Fade(textTint, guiAlpha));
    //------------------------------------------------------------------
